...
model = LifelongSidetuneNetwork(
    base_class='ResnetiCifar56NoLinear',
    base_kwargs={ 'eval_only': True },
    base_weights_path='../side-tuning/assets/pytorch/resnet56-cifar.pt',
    side_class='FCN4Reshaped',
    side_kwargs={ 'eval_only': False },
    side_weights_path='../side-tuning/assets/pytorch/distillation/distillation_resnet56.pth',
