...
from .resnet_cifar import ResnetiCifar56NoLinearWithCache, ResnetiCifar56NoLinear
from .resnet_cifar import ResnetiCifar32NoLinearWithCache, ResnetiCifar32NoLinear
...
class LifelongSidetuneNetwork(LifelongNetwork):
    ...
    def forward(self, x, task_idx=None, pass_i=0):
        ...
        if self.pnn:
            ...
            assert isinstance(self.base, TaskonomyEncoderWithCache) or isinstance(self.base, ResnetiCifar56NoLinearWithCache), 'PNN needs to have cache!'
