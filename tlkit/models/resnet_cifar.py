...
##### ResnetiCifar56
class ResnetiCifar56(ResNet):
    def __init__(self, bsp=False, **new_kwargs):
        if bsp:
            super().__init__(HashBasicBlock, [9, 9, 9], **new_kwargs)
        else:
            super().__init__(BasicBlock, [9, 9, 9], **new_kwargs)
        self.bsp = bsp
...
class ResnetiCifar56NoLinear(ResNet):
    def __init__(self, bsp=False, final_act=True, **new_kwargs):
        if bsp:
            super().__init__(HashBasicBlock, [9, 9, 9], **new_kwargs)
        else:
...
class ResnetiCifar56NoLinearWithCache(ResnetiCifar56NoLinear):
    def forward(self, x, time:int=-1):
        self.x_pre_layer1 = F.relu(self.bn1(self.conv1(x)))  # (16,32,32)
        self.x_layer1 = self.layer1(self.x_pre_layer1)       # (16,32,32)
        self.x_layer2 = self.layer2(self.x_layer1)           # (32,16,16)
...
########### Resnet32
class ResnetiCifar32(ResNet):
    def __init__(self, bsp=False, **new_kwargs):
        if bsp:
            super().__init__(HashBasicBlock, [5, 5, 5], **new_kwargs)
        else:
            super().__init__(BasicBlock, [5, 5, 5], **new_kwargs)
        self.bsp = bsp
...
class ResnetiCifar32NoLinear(ResNet):
    def __init__(self, bsp=False, final_act=True, **new_kwargs):
        if bsp:
            super().__init__(HashBasicBlock, [5, 5, 5], **new_kwargs)
        else:
...
class ResnetiCifar32NoLinearWithCache(ResnetiCifar32NoLinear):
    def forward(self, x, time:int=-1):
        self.x_pre_layer1 = F.relu(self.bn1(self.conv1(x)))  # (16,32,32)
        self.x_layer1 = self.layer1(self.x_pre_layer1)       # (16,32,32)
        self.x_layer2 = self.layer2(self.x_layer1)           # (32,16,16)
